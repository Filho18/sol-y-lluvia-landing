...
const ToldoContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (selectedMethod === 'whatsapp') {
      ...
      const message = `*Solicitud de Presupuesto - Toldos*%0A%0A` +
  ...
  return (
    <section id="contacto-toldo" className="py-16 lg:py-20 bg-gray-50">
...
export default ToldoContactSection;
