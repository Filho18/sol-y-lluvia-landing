...
const ToldoTestimonialsSection = () => {
  const testimonials = [
    {
    ...
    },
    {
      ...
      text: "Me quedé impresionada con la rapidez de respuesta y ejecución. ¡En menos de dos semanas tenía mi toldo instalado!",
      rating: 5
    },
    {
      name: "Miguel Santos",
...
export default ToldoTestimonialsSection;
