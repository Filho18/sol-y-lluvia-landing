    ...
    <section id="contacto" className="py-16 lg:py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <div className="text-lg text-blue-600 font-semibold max-w-2xl mx-auto bg-blue-50 border-l-4 border-blue-400 px-4 py-3 rounded-r-lg">
            <p>✨ <strong>¿Listo para transformar tu espacio? Contáctanos y solicita tu presupuesto gratuito</strong></p>
          </div>
        </div>
