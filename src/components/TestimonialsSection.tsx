  ...
  return <section className="py-16 lg:py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-3xl lg:text-4xl font-light text-gray-900 mb-6">Lo Que Dicen Nuestros Clientes</h2>
        </div>
              ...
              {testimonials.map((testimonial, index) => <CarouselItem key={index} className="pl-4 md:basis-1/2 lg:basis-1/3">
                  <div className="bg-white rounded-xl p-6 lg:p-8 shadow-sm h-full flex flex-col">
                    ...
                    <div className="flex justify-center mb-4">
                      {[...Array(testimonial.rating)].map((_, i) => <span key={i} className="text-amber-400 text-lg">★</span>)}
                    </div>
